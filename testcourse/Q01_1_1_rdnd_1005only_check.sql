CREATE VIEW "Q01_1_1_rdnd_1005only" AS
...
FROM 
 ...
 LEFT JOIN
  public."1_1_rlnk_01" AS rl1 ON (rn1.shp_node=rl1.shp_node1 OR rn1.shp_node=rl1.shp_node2)
 LEFT JOIN
  public."2_4_rlnk_01" AS rl2 ON (rn1.shp_node=rl2.shp_node1 OR rn1.shp_node=rl2.shp_node2)
 LEFT JOIN
  public.csv_1_1_1002_01 AS c112 ON rn1.shp_node=c112.shp_node 
 LEFT JOIN
  public.csv_1_1_1005_01 AS c115 ON rn1.shp_node=c115.shp_node 
 LEFT JOIN
  public.csv_1_1_2003_01 AS c123 ON (rn1.shp_node=c123.shp_node1 OR rn1.shp_node=c123.shp_node2)
 LEFT JOIN
  public.csv_1_1_5001_drm AS c151 ON (rn1.shp_node=c151.shp_node1 OR rn1.shp_node=c151.shp_node2)
 LEFT JOIN
  public.csv_1_1_6001_1_01 AS c1611 ON rn1.shp_node=c1611.shp_node1
 LEFT JOIN
  public.csv_1_1_6001_2_01 AS c1612 ON rn1.shp_node=c1612.shp_node1 

 LEFT JOIN
  public.csv_2_4_1001_01 AS c211 ON rn1.shp_node=c211.shp_node
 LEFT JOIN
  public.csv_2_4_1002_01 AS c212 ON rn1.shp_node=c212.shp_node  
 LEFT JOIN
  public.csv_2_4_1004_01 AS c214 ON rn1.shp_node=c214.shp_node  
 LEFT JOIN
  public.csv_2_4_2002_02 AS c222 ON (rn1.shp_node=c222.shp_node1 OR rn1.shp_node=c222.shp_node2)
 LEFT JOIN
  public.csv_2_4_2003_01 AS c223 ON (rn1.shp_node=c223.shp_node1 OR rn1.shp_node=c223.shp_node2)
 LEFT JOIN
  public.csv_2_4_2004_01 AS c224 ON (rn1.shp_node=c224.shp_node1 OR rn1.shp_node=c224.shp_node2)  
 LEFT JOIN
  public.csv_2_4_2006_r AS c226r ON (rn1.shp_node=c226r.shp_node1 OR rn1.shp_node=c226r.shp_node2 OR rn1.shp_node=c226r.shp_node11 OR rn1.shp_node=c226r.shp_node21)   
 LEFT JOIN
  public.csv_2_4_2006_rc AS c226rc ON (rn1.shp_node=c226rc.shp_node1 OR rn1.shp_node=c226rc.shp_node2 OR rn1.shp_node=c226rc.shp_node11 OR rn1.shp_node=c226rc.shp_node21)   
 LEFT JOIN
  public.csv_2_4_2006_s AS c226s ON (rn1.shp_node=c226s.shp_node1 OR rn1.shp_node=c226s.shp_node2)  
 LEFT JOIN
  public.csv_2_4_5001_drm AS c251 ON (rn1.shp_node=c251.shp_node1 OR rn1.shp_node=c251.shp_node2)
 LEFT JOIN
  public.csv_2_4_6001_1_01 AS c2611 ON rn1.shp_node=c2611.shp_node1
 LEFT JOIN
  public.csv_2_4_6001_2_01 AS c2612 ON rn1.shp_node=c2612.shp_node1 
