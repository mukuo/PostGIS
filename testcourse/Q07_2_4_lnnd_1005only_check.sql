CREATE VIEW "Q07_2_4_lnnd_1005only" AS
...
FROM 
 ...
 LEFT JOIN
  public."1_1_llnk_01" AS ll1 ON (ln2.shp_node=ll1.shp_node1 OR ln2.shp_node=ll1.shp_node2)
 LEFT JOIN
  public."2_4_llnk_01" AS ll2 ON (ln2.shp_node=ll2.shp_node1 OR ln2.shp_node=ll2.shp_node2)
 LEFT JOIN
  public.csv_1_1_1002_01 AS c112 ON ln2.shp_node=c112.shp_node 
 LEFT JOIN
  public.csv_1_1_1005_01 AS c115 ON ln2.shp_node=c115.shp_node 
 LEFT JOIN
  public.csv_1_1_2003_01 AS c123 ON (ln2.shp_node=c123.shp_node1 OR ln2.shp_node=c123.shp_node2)
 LEFT JOIN
  public.csv_1_1_5001_drm AS c151 ON (ln2.shp_node=c151.shp_node1 OR ln2.shp_node=c151.shp_node2)
 LEFT JOIN
  public.csv_1_1_6001_1_01 AS c1611 ON ln2.shp_node=c1611.shp_node1
 LEFT JOIN
  public.csv_1_1_6001_2_01 AS c1612 ON ln2.shp_node=c1612.shp_node1 

 LEFT JOIN
  public.csv_2_4_1001_01 AS c211 ON ln2.shp_node=c211.shp_node
 LEFT JOIN
  public.csv_2_4_1002_01 AS c212 ON ln2.shp_node=c212.shp_node  
 LEFT JOIN
  public.csv_2_4_1004_01 AS c214 ON ln2.shp_node=c214.shp_node  
 LEFT JOIN
  public.csv_2_4_2002_02 AS c222 ON (ln2.shp_node=c222.shp_node1 OR ln2.shp_node=c222.shp_node2)
 LEFT JOIN
  public.csv_2_4_2003_01 AS c223 ON (ln2.shp_node=c223.shp_node1 OR ln2.shp_node=c223.shp_node2)
 LEFT JOIN
  public.csv_2_4_2004_01 AS c224 ON (ln2.shp_node=c224.shp_node1 OR ln2.shp_node=c224.shp_node2)  
 LEFT JOIN
  public.csv_2_4_2006_r AS c226r ON (ln2.shp_node=c226r.shp_node1 OR ln2.shp_node=c226r.shp_node2 OR ln2.shp_node=c226r.shp_node11 OR ln2.shp_node=c226r.shp_node21)   
 LEFT JOIN
  public.csv_2_4_2006_rc AS c226rc ON (ln2.shp_node=c226rc.shp_node1 OR ln2.shp_node=c226rc.shp_node2 OR ln2.shp_node=c226rc.shp_node11 OR ln2.shp_node=c226rc.shp_node21)   
 LEFT JOIN
  public.csv_2_4_2006_s AS c226s ON (ln2.shp_node=c226s.shp_node1 OR ln2.shp_node=c226s.shp_node2)  
 LEFT JOIN
  public.csv_2_4_5001_drm AS c251 ON (ln2.shp_node=c251.shp_node1 OR ln2.shp_node=c251.shp_node2)
 LEFT JOIN
  public.csv_2_4_6001_1_01 AS c2611 ON ln2.shp_node=c2611.shp_node1
 LEFT JOIN
  public.csv_2_4_6001_2_01 AS c2612 ON ln2.shp_node=c2612.shp_node1 
